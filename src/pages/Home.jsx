...
export default function Home() {
  ...
  const quickLinks = [
    { img: githubLogo, title: 'GitHub', link: 'https://github.com/Gagan956' },
    { img: linkedinLogo, title: 'LinkedIn', link: 'https://www.linkedin.com/in/gagan9560/' },
    { img: gmailLogo, title: 'Email', link: 'mailto:gagansharma9560@gmail.com' },
    { img: whatsappLogo, title: 'WhatsApp', link: 'https://wa.me/+919354371766' },
      ...
      <div className="home-top">
        ...
        >
          ...
          <p className="typing-effect">
            Software Developer Engineer | Full Stack Developer | Tech Explorer
          </p>
          ...
          <motion.div className="info-cards">
            {[
              ...
              { label: '💼 Expertise', value: 'SDE, Problem Solving' },
              { label: '📧 Contact', value: 'gagansharma9560@gmail.com' },
            ].map((info, i) => (
